...
- (id)initWithDelegate:(id)delegate groupId:(NSString*)groupId{
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"radio_checked.png"] forState:UIControlStateHighlighted];
...
-(void)setEnabled:(BOOL)enabled
{
    ...
    if(!enabled)
    {
       [self setImage:[UIImage imageNamed:@"radio_unchecked.png"] forState:UIControlStateDisabled];
       [self setImage:[UIImage imageNamed:@"radio_checked_gray.png"] forState:UIControlStateNormal];
       [self setImage:[UIImage imageNamed:@"radio_checked.png"] forState:UIControlStateHighlighted];
    }
