...
NSString *kYingXinURL;//迎新webService
NSString *kStuState;//学生状态
...
//    http://203.195.180.189/GetUserPwdIsRight.php
    ...
    [[UITabBar appearance] setBackgroundImage:tabBarBackGroungImg];
    [[UINavigationBar appearance] setBarTintColor:[UIColor colorWithRed:0.0f green:102/255.0f blue:203/255.0f alpha:1.0f]];
    ...
    NSString *urlStr=@"https://itunes.apple.com/cn/lookup?id=";
    urlStr=[urlStr stringByAppendingString:@"1419673819"];
