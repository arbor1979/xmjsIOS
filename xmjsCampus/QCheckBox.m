...
-(void)setEnabled:(BOOL)enabled
{
    ...
    if(!enabled)
    {
        [self setImage:[UIImage imageNamed:@"checkbox1_unchecked.png"] forState:UIControlStateDisabled];
        [self setImage:[UIImage imageNamed:@"checkbox1_checked_gray.png"] forState:UIControlStateNormal];
    }
}
